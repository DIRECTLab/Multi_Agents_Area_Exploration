        ...
        if self.id == 0:
            ...
            for i in range(num_bots):
                ...
                if(i == num_bots - 1):
                    ...
                    if 'required_environment_steps' not in mutual_data['Agent_Data']:
                        mutual_data['Agent_Data']['required_environment_steps'] = []
                    mutual_data['Agent_Data']['total_explored_at_point'].append([exploration_stop, mutual_data['total_explored_area'][-1]])
                    mutual_data['Agent_Data']['required_environment_steps'].append(self.frame_count)
