...
class Experiment:
    ...
    def clean_up_experiment(self):
        ...
        folder = f"new_data_limited/multiple_method_search_data/start_scenario{self.experiment_name.split('/')[2]}/goal_scenario_{self.experiment_name.split('/')[3]}/bots-{len(self.bots)}_min-room-size{self.cfg.MIN_ROOM_SIZE / self.cfg.GRID_THICKNESS}"
